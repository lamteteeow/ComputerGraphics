function webGLStart(canvas) {
    ...
    vertices.push(0);
    vertices.push(r);
    vertices.push(r*Math.sin(ankle));
    vertices.push(r*Math.cos(ankle));
    ...
    for (var i = 1; i <= slices; i++) {
        vertices.push(r*Math.sin(ankle*i));
        vertices.push(r*Math.cos(ankle*i));
        indices.push(0);
        indices.push(i+1);
        indices.push(i+2);
    }
